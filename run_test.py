...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, required=True, choices=SUPPORTED_DATASETS, help='dataset name for loading data')
    ...
    parser.add_argument('--train_config', type=str, required=True, help='train config file')
    parser.add_argument('--test_config', type=str, required=True, help='test config file')
