...
class MultiModal_Paired_Windows_Attention(Paired_Windows_Attention):
    ...
    def __init__(self,
        ...
        if self.num_heads > 0:
            ...
            for m in range(self.num_modalities):
                ...
                self.local_attns.append(get_conv(dim)(self.channels_v, self.channels_v, 3, 1, 1, groups=self.num_heads_bswin))
    ...
    def forward(self, inputs):
        ...
        for m in range(self.num_modalities):
            ...
            value = self.qkv_proj[m][2](self.input_norms[m](inputs[m]))
            values.append(value + self.local_attns[m](value))
