...
def run_train(args, train_config, model_config):
    ...
    train_transforms = Compose(
            [
                ...
                # image size is too small to crop foreground
    ...
    for epoch in range(start_epoch, train_config['epochs']):
        ...
        logger.info(f"training epoch {epoch + 1}: average [Loss: {mean_loss:4f}, FP:{mean_fp:.4f}, FN:{mean_fn:.4f}, IoU:{mean_iou:.4f}, Dice:{mean_dice:.4f}]")
